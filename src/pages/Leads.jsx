  ...
  return (
    <div className="space-y-4">
      <div className="card flex flex-wrap items-center gap-2.5 p-3">
        ...
        <span className="text-[12px] text-slate-500">{total} lead{total === 1 ? '' : 's'}</span>
      </div>
      ...
      <div className="card overflow-hidden">
        {loading ? (
          ...
          <Empty icon={Inbox} title="No enquiries found" sub="Leads submitted from the website appear here." />
        ) : (
      ...
      {view && (
        <Modal open onClose={() => setView(null)} title="Enquiry details" width="max-w-lg"
          footer={<>
          ...
          <div className="space-y-3">
            ...
            <dl className="grid grid-cols-2 gap-x-4 gap-y-2.5 text-[13px]">
              {[
                ...
                ['Hotel', view.hotelName || view.hotelId?.name || '—'], ['Created', fmtDate(view.createdAt)],
